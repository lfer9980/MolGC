...
from app.src.analysis.application.report.get_all_by_job.service import GetAllByJobReportService
...
async def get_all_report(
    ...
    if job_entity.status != JobStatusEnum.COMPLETED:
        raise HTTPException(
            status_code=422, detail="The job was not completed successfully Report generation yet."
        )
