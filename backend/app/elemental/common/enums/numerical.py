...
class ElementalIntEnum(_IntEnum, Enum):
    ...
    This class combines Python's `IntEnum` and `Enum`
    to allow enum members to be integers
    while still providing full enumeration functionality.
    ...
    def to_list(cls) -> List[Union[float, int]]:
        """Return enum as a list of integers."""
